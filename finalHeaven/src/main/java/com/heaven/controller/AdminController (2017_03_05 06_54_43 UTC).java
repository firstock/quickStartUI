...
//	}
	...
	public ModelAndView goLoginGet(){
		System.out.println("AdminController goLoginGet");
		return new ModelAndView("admin/adminLogin");
	}
	...
	@RequestMapping(value="/adminQnaAnswer.ad", method=RequestMethod.GET)
	public ModelAndView goQnaAnswer(){
		System.out.println("AdminController goQnaAnswer");
		return new ModelAndView("admin/adminQnaAnswer");
	}
